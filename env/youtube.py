...
class YouTube:
    ...
    def init_service(self, force_reauth=False):        
        self.service = create_service(self.client_file, self.API_NAME, self.API_VERSION, self.SCOPES, force_reauth=force_reauth)
